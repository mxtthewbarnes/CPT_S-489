  ...
  const listings = await Listing.bulkCreate([
    {
      ...
      imageUrl: makeImage('WSU Crewneck', '#981e32'),
      status: 'active',
    },
    {
      sellerId: seller.id,
      ...
      imageUrl: makeImage('UW Hoodie', '#4b2e83'),
      status: 'active',
    },
    {
      sellerId: seller.id,
      title: 'Oregon Varsity Jacket',
      category: 'Jacket',
      school: 'Oregon',
      price: 48.0,
      size: 'XL',
      ...
      imageUrl: makeImage('Oregon Jacket', '#154733'),
      status: 'active',
    },
    {
      sellerId: seller.id,
      ...
      imageUrl: makeImage('UCLA Tee', '#2774ae'),
      status: 'active',
    },
    {
      sellerId: seller.id,
    ...
    },
    {
      ...
      imageUrl: makeImage('Notre Dame Zip', '#0c2340'),
      status: 'active',
    },
    {
      sellerId: seller.id,
